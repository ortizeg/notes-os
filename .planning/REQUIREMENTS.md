...
- [x] **TUI-03**: SortScreen runs the inbox triage flow end-to-end
- [x] **TUI-04**: TaskExtractScreen reviews extracted tasks after each note when extraction is enabled
...
| TUI-03 | Phase 6 — Textual TUI Integration | Complete |
| TUI-04 | Phase 6 — Textual TUI Integration | Complete |
